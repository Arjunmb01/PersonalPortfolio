...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      className="border-t border-blueprint-grid/30 w-full"
    >
      <div
        ref={sectionRef}
        className="relative min-h-screen md:h-screen md:flex md:flex-col md:justify-center py-24 md:py-0 overflow-hidden"
      >
